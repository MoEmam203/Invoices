						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								@can('partial paid invoices')
									<li><a class="slide-item" href="{{ url('/' . $page='partialPaidInvoices') }}">الفواتير المدفوعة جزئيا</a></li>
								@endcan

								@can('archive invoice')
									<li><a class="slide-item" href="{{ url('/' . $page='invoicesArchive') }}">ارشيف الفواتير</a></li>
								@endcan
							</ul>
						</li>
					@endcan
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								@can('invoices reports')
									<li><a class="slide-item" href="{{ url('/' . $page='InvoiceReports') }}">تقارير الفواتير</a></li>
								@endcan

								@can('users reports')
									<li><a class="slide-item" href="{{ url('/' . $page='customerReports') }}">تقارير العملاء</a></li>
								@endcan
							</ul>
						</li>
					@endcan
