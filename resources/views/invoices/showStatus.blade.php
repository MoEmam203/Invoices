...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route("update.invoice.status",$invoice) }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    {{-- 1 --}}
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" name="invoice_date" placeholder="YYYY-MM-DD"
                                type="text" value="{{ date('Y-m-d') }}" value="{{ $invoice->invoice_date }}" readonly disabled required>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <input class="form-control fc-datepicker" name="due_date" value="{{ $invoice->due_date }}" placeholder="YYYY-MM-DD"
                                type="text" readonly disabled required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <select name="section_id" class="form-control SlectBox" disabled readonly>
                        ...
                        <div class="col">
                            ...
                            <select id="product_id" name="product_id" class="form-control" disabled readonly>
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="amount_collection" value="{{ $invoice->amount_collection }}" name="amount_collection" readonly
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="rate_vat" id="rate_vat" class="form-control" onchange="calVAT()" readonly>
                                <!--placeholder-->
                    ...
                    <div class="row my-3">
                        <div class="col-6">
                            <label for="status" class="control-lable">الحالة الحالية</label>
                            <select name="status" id="status" class="form-control">
                                <option selected="true" disabled="disabled">-- حدد حالة الدفع --</option>
                                <option value="1">مدفوعة</option>
                                <option value="3">مدفوعة جزئبا</option>
                            </select>
                        </div>

                        <div class="col-6">
                            <label for="payment_date" class="control-lable">تاريخ الدفع</label>
...
<script>
    $(document).ready(function() {
        $('select[name="section_id"]').on('change', function() {
            ...
            if (sectionID) {
                $.ajax({
                    url: "{{ URL::to('sectionProducts') }}/" + sectionID,
                    type: "GET",
                    dataType: "json",
