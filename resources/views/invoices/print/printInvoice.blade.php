								...
								<div class="card-body">
									<div class="invoice-header">
										...
										<div class="billed-from">
											<h6>Mustafa Comapny</h6>
											<p>Mansoura , Dakahlia , Egypt<br>
											Tel No: 324 445-4544<br>
											Email: mustafa@mustafacompany.com</p>
										</div><!-- billed-from -->
									</div><!-- invoice-header -->
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="tx-right" colspan="2">{{ number_format($invoice->value_vat) }}</td>
												</tr>
												<tr>
									...
									<hr class="mg-b-40">
									<a href="#" class="btn btn-success float-left mt-3 mr-2" id="printBtn" onclick="Print()">
