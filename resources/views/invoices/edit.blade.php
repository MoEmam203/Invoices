                ...
                <form action="{{ route('invoices.update',$invoice) }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="amount_collection" value="{{ $invoice->amount_collection }}" name="amount_collection"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <select name="rate_vat" id="rate_vat" class="form-control" onchange="calVAT()">
                                <!--placeholder-->
